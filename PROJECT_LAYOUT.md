...
├── digital/         SNN core RTL 13개 .v (시뮬용 서브셋)
├── fpga/            ★FPGA/Vivado 정식 자료 (← 디지털 설계 블록 양건)
...
│   └── afe_output_xmodelmatch/        ★XModel 정합 AFE+ADC 출력 (1200, signed+unsigned) [정본]
...
- **디지털 RTL**: 시뮬=`digital/`, FPGA 정식=`fpga/SNN_ECG.srcs/`
