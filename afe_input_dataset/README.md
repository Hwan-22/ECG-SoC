...
| 파일 | 클래스 | 샘플수 | code 범위 | 전압 범위 |
|---|---|---|---|---|
| `afe_input_NSR.csv` | 정상(NSR) | 60000 | −98 ~ 424 | −0.49 ~ 2.12 mV |
| `afe_input_CHF.csv` | 울혈성심부전(CHF) | 60000 | −318 ~ 626 | −1.59 ~ 3.13 mV |
| `afe_input_ARR.csv` | 부정맥(ARR) | 60000 | −604 ~ 502 | −3.02 ~ 2.51 mV |
| `afe_input_AFF.csv` | 심방세동(AFF) | 60000 | −389 ~ 368 | −1.95 ~ 1.84 mV |
| `afe_input_record100_NSR.csv` | MIT-BIH rec100(NSR) | 3600 | (360Hz native) | XModel 단일-레코드 주입본 |
